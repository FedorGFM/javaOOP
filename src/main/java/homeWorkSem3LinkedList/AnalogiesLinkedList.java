...
public class AnalogiesLinkedList<E> implements Iterable<E> {
    private int size = 0;
    private Unit<E> first;
    private Unit<E> second;
    ...
    private Unit<E> getUnit(int index) {
        ...
        Unit<E> unit = backwardSearch ? second : first;
